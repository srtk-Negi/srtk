  ...
  return (
    <div className="intro">
      ...
      <h2>
        ...
        <span className="text-highlight">Internship</span> opportunities for
        Summer 2024. Currently, I am working as a{" "}
        ...
        <span className="text-highlight">maintainace</span> of our application,{" "}
        <span className="text-highlight">collecting data</span> and{" "}
        <span className="text-highlight">managing databases</span> for projects
        ...
        <span className="text-highlight">modeling tasks</span>. I thrive in{" "}
        <span className="text-highlight">collaborative environments</span> and
        thoroughly enjoy being part of a{" "}
        <span className="text-highlight">team</span>. I am always ready to take
        on higher responsibilities and contribute to the success of a project.{" "}
        <span className="text-highlight">Passionate</span> and eager to learn, I
