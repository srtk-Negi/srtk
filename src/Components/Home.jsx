  ...
  return (
    <div className="homePageContent">
      ...
      <h2>
        ...
        <span className="text-highlight"> Research Assistant</span> at the{" "}
      ...
      <h2>
        Junior <span className="text-highlight">Computer Science</span> student
        at The University of Texas at San Antonio with a concentration in{" "}
